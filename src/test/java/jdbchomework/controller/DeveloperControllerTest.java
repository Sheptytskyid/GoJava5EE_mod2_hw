...
public class DeveloperControllerTest {
    ...
    public void shouldAddDeveloperToDB() {
        developerController.addDeveloper(SOME_NAME);
        verify(developerService, times(1)).addDeveloper(SOME_NAME);
    }
    ...
    public void shouldUpdateDeveloperById() {
        when(developerService.updateDeveloperById(ID, SOME_NAME)).thenReturn(true);
        assertTrue(developerController.updateDeveloperById(ID, SOME_NAME));
    }
