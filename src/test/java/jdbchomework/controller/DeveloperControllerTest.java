...
import static jdbchomework.utils.TestUtils.DEVELOPER_NAME;
...
public class DeveloperControllerTest {
    ...
    public void shouldAddDeveloperToDB() {
        developerController.addDeveloper(DEVELOPER_NAME);
        verify(developerService, times(1)).addDeveloper(DEVELOPER_NAME);
    }
    ...
    public void shouldUpdateDeveloperById() {
        when(developerService.updateDeveloperById(ID, DEVELOPER_NAME)).thenReturn(true);
        assertTrue(developerController.updateDeveloperById(ID, DEVELOPER_NAME));
    }
